...
BX1 = And(Implication(AKnight, AKnave), Implication(AKnave, Not(AKnave)))
BX2 = CKnave
CX = AKnight
...
knowledge3 = And(
    rules,
    AX,
    Implication(BKnight, And(BX1, BX2)),
    Implication(BKnave, And(Not(BX1), Not(BX2))),
    Implication(CKnight, CX),
    Implication(CKnave, Not(CX))    
)
